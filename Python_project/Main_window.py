...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Amplituda = QtWidgets.QDoubleSpinBox(self.frame_2)
        self.Amplituda.setAcceptDrops(True)
        self.Amplituda.setMaximum(100000.0)
        self.Amplituda.setObjectName("Amplituda")
        self.verticalLayout_2.addWidget(self.Amplituda)
        self.label_7 = QtWidgets.QLabel(self.frame_2)
        self.label_7.setObjectName("label_7")
        self.verticalLayout_2.addWidget(self.label_7)
        self.Omega = QtWidgets.QDoubleSpinBox(self.frame_2)
        self.Omega.setMouseTracking(True)
        self.Omega.setAcceptDrops(True)
        self.Omega.setAccessibleName("")
        self.Omega.setAutoFillBackground(False)
        self.Omega.setWrapping(False)
        self.Omega.setFrame(True)
        self.Omega.setObjectName("Omega")
        self.verticalLayout_2.addWidget(self.Omega)
